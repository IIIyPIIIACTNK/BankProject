...
namespace BankProject
{
        ...
        IEventProvider
    {
        ...
        public event Action<Resident, BankAccount, float, OperationType, Exception> OperationCancelEvent;
        ...
        public BankAccount(int id, Resident owner)
        {
            ...
            OperationCancelEvent += log.ReciveData;
            this.owner = owner;
        }
        ...
        protected void InvokeCanselOperationEvent(Resident res, BankAccount bankAccount,float ammount, OperationType oP, Exception exception) 
        {
            OperationCancelEvent?.Invoke(res,bankAccount,ammount, oP, exception);
        }
